    ...
    public String requestFileUploadWithText(
        ...
        try {
            for (MultipartFile multipartFile: fileList) {
                ...
                // 등록한 시간을 파일명에 붙여서 파일을 저장
                FileOutputStream writer = new FileOutputStream(
                        "C:/Users/user2/Documents/GitHub/KHGPM-Frontend/LeeHyeonjin/frontend/src/assets/uploadImgs/" +
                                // ../../KHGPM-Frontend/LeeHyeonjin/frontend/src/assets/uploadImgs/
